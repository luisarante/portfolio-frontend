...
const TerminalSimulator: React.FC = () => {
  return (
    <div 
      className="hidden lg:flex flex-col w-full max-w-2xl h-full bg-gray-900 border border-gray-700 shadow-2xl rounded-lg overflow-hidden font-mono text-sm"
    >
      ...
      <div className="flex-1 p-6 text-green-400 overflow-hidden">
        <Typewriter
          options={{
            delay: 30, 
            loop: true,
          ...
          onInit={(typewriter) => {
            typewriter
              ...
              .typeString('<span class="text-white">Aplicação rodando em:</span> <span class="text-blue-400 underline">https://luisarantes.com.br</span><br/>')
              .pauseFor(1000)
